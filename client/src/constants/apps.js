...
const appsCreator = (
  ...
  fileSystem: {
    ...
    html: (
      <FileSystem
        level={level}
        socket={socket}
        folders={fileSystemFolders}
        openCallBack={openApplication}
      />
    ),
  },
  videoStream: {
  ...
  elevator_landing: {
    ...
    html: (
      <img
        src="/hallways/hallway.jpg"
        style={{ maxHeight: 500 }}
        alt="Hallways outside elevator"
      />
    ),
  },
  vault_door: {
    name: "IMG083123",
    html: (
      <img src="/vault/door.jpg" style={{ maxHeight: 500 }} alt="Vault door" />
    ),
  },
  tubes: {
    name: "IMG083125",
  ...
  subject1: {
    name: "IMG083130",
    html: (
      <img src="/vault/subject1.jpg" style={{ maxHeight: 500 }} alt="Subject" />
    ),
  },
  subject2: {
    name: "IMG083131",
    html: (
      <img src="/vault/subject2.jpg" style={{ maxHeight: 500 }} alt="Subject" />
    ),
  },
  computer: {
    name: "IMG083137",
  ...
  cameras: {
    name: "IMG083143",
    html: (
      <img src="/vault/cameras.jpg" style={{ maxHeight: 500 }} alt="Cameras" />
    ),
  },
  powder: {
    name: "IMG083145",
    html: (
      <img src="/vault/powder.jpg" style={{ maxHeight: 500 }} alt="Powder" />
    ),
  },
  languageTranscript1: {
    ...
    html: (
      <div className="error-pop-up">
        ...
        <div className="details">
          ...
          <p>
            To restore enough memory for programs to work correctly, close one
            of the above applications and try again.
          </p>
          <button
            onClick={() => {
              closeApplication("tooMuchRamPopUp");
            }}
          >
            OK
          </button>
