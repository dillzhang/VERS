...
const languageTranscript1 =
	<div className="document-holder">
        <div className="transcript">
            ...
            <p><strong>I1:</strong> Ƕ∂ỼϬ∫!</p>
            <p><strong>S:</strong> ...</p>
            <p><strong>I2:</strong> We have many questions to ask you.</p>
            <p><strong>I2:</strong> Can you tell us what is this?</p>
            <p><strong>S:</strong> A photograph?</p>
            <p><strong>I2:</strong> ට ↻చվ∫վԱلට↻చ.</p>
            <p><strong>I1:</strong> վჯ.</p>
            <p><strong>I2:</strong> What is a photograph?</p>
            ...
            <p><strong>I2:</strong> ට հϬհվل§.</p>
            <p><strong>I2:</strong> What is a memory?</p>
            <p><strong>S:</strong> It's something that happened in the past.</p>
            <p><strong>I2:</strong> ∫చϬ ↻ටⱮ∫.</p>
            <p><strong>I1:</strong> վჯ.</p>
